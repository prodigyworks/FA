...
<img src="images/login-page.png" />
		...
		<script>
			function checkForgotPassword() {
				if ($("#login").val() != "") {
					$("#loginDialog .confirmdialogbody").html("You are about to reset the password.<br>Are you sure ?");
			...
			$(document).ready(function() {
					...
					$("#dialog").dialog({
							...
							width: 480,
							closeOnEscape: false,
							dialogClass: '<?php if (getSiteConfigData()->maintenancemode == "Y") echo "login-dialog2"; else echo "login-dialog"; ?>',
